...
const projects = [
  ...
  },
  {
    ...
    category: "Full-stack",
    title: "Airbnb Clone",
    description: "A clone of the Airbnb platform featuring property listings, booking functionalities, and a responsive design for a seamless user experience.",
    stack: [{name: "Next JS"}, {name: "Tailwind CSS"}, {name: "MongoDB"}, {name: "JavaScript"}],
    image: "/airbnb.png",
    live: "",
    github: "https://github.com/AbdelazizEbrahim/airbnb-clone",
  },
];
