          ...
          <div className='xl:w-[54%] order-2 xl:order-none'>
            <form className='flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl'>
              ...
              <p className='text-white/60'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                       Doloribus dolore enim exercitationem illum, explicabo praesentium. 
              </p>
              {/* inputs */}
                ...
                <SelectTrigger classname="w-full">
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="cst">Content Creation</SelectItem>
                      <SelectItem value="mst">Facebook Ads</SelectItem>
                    </SelectGroup>
                  </SelectContent>
                </SelectTrigger>
              </Select>
